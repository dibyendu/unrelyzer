...
\title{Interval Analysis of Probabilistic Programming Languages --- A first Manuscript\tnoteref{t1}}
\tnotetext[t1]{A popular static analysis tool for Probabilistic Programming Languages}
...
From the above arguments we can infer that in the concrete domain each possible program state is associated with some probability. We represent program state as a tuple of value and its associated probability. Set of all possible program states is thus represented by
