...
\centerline{
  \hl{$L=\left\{\left(S,p\right)\ \middle|\ S\in2^{\mathbb{Z}}\bigwedge p\in\mathbb{R}\bigwedge \forall s\in S, \mathtt{MININT}\leq s\leq\mathtt{MAXINT}\bigwedge 0\leq p\leq1\right\}$}
}
